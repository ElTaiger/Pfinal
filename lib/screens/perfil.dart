...
// aquí miro si dos fechas son del mismo dia
...
class _PantallaPerfilState extends State<PantallaPerfil> {
  ...
  Future<void> _actualizarPedidos() async {
    await AppState().actualizarPedidosIdioma();
    if (mounted) setState(() {});
  }
            ...
            body: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Divider(color: Colors.white24),
                  if (AppState().pedidosRealizados.isNotEmpty)
                    _buildFiltroFecha(),
                  _buildListaPedidos(),
                  const SizedBox(height: 30),
                  Center(
  ...
  Widget _buildListaPedidos() {
    ...
    // aquí filtro por el dia seleccionado si hay uno
